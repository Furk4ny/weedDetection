...
transform = transforms.Compose([
    transforms.Resize((224, 224)),  # MobileNetV2 için önerilen boyut
    transforms.ToTensor()
])
...
# ================================
# 2️⃣ MobileNetV2 Modeli
# ================================
print("\n🚀 MobileNetV2 eğitimi başlatılıyor...")

model = models.mobilenet_v2(weights=models.MobileNet_V2_Weights.DEFAULT)
model.classifier[1] = nn.Linear(model.classifier[1].in_features, 2)  # 2 sınıf (crop vs weed)
