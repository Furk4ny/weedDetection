...
transform = transforms.Compose([
    transforms.Resize((224, 224)),  # EfficientNet-B0 için minimum önerilen boyut
    transforms.ToTensor()
])
...
print("\n🚀 EfficientNet-B0 eğitimi başlatılıyor...")

model = models.efficientnet_b0(weights=models.EfficientNet_B0_Weights.DEFAULT)
model.classifier[1] = nn.Linear(model.classifier[1].in_features, 2)  # 2 sınıf
...
print("✅ EfficientNet-B0 eğitimi tamamlandı.")
