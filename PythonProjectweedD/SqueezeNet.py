...
# ================================
# 2️⃣ SqueezeNet Modeli
# ================================
print("\n🚀 SqueezeNet eğitimi başlatılıyor...")

model = models.squeezenet1_0(weights=models.SqueezeNet1_0_Weights.DEFAULT)
model.classifier[1] = nn.Conv2d(512, 2, kernel_size=1)  # 2 sınıfa uyarlama
model.num_classes = 2
...
# ================================
# 3️⃣ Ortalama Skorlar (Validation seti)
# ================================
...
print("✅ SqueezeNet eğitimi tamamlandı.")
